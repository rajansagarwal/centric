...
export const getStaticProps = async () => {
  const res = await fetch('https://bloomnetwork-api.vercel.app/1.json');
    ...
    <p>Ensure Metamask is installed.</p>
      ...
      {isAuthenticated ? (
        <>
          ...
          <br/>
          <h3>Scanned EHR</h3>
          <img src="https://bloomnetwork-api.vercel.app/ARSE.png" width="500px"/>
          <br/><br/>
          <div>
            {graph.map(graphical => (
