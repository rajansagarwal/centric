...
export default function Home({ graph }) {
  ...
  return (
    ...
    <p>Please ensure that you are on the Ethereum Mainnet.</p>
      ...
      <iframe src="//bloomnetwork-api.vercel.app" height="700px" width="700px" frameBorder='0'/><br/><u><Link href="https://github.com/rajanwastaken/bloom/tree/main/ML-foundation">View NLP Connections & Data Matrix</Link></u><br/><br/><br/><br/>
    </div> 
  );
}